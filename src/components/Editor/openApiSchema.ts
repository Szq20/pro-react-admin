/* eslint-disable */
/**
 * @file: schemas for openapi
 * @author: gaopengyue(gaopengyue@baidu.com)
 */

export const OPENAPI_SCHEMA_20 = {
...
export const OPENAPI_SCHEMA_30 = {
...
export const OPENAPI_SCHEMA_31 = {
...
export const OPENAPI_VERSION_REG_31 = '^3\\.1\\.\\d+(-.+)?$';
export const OPENAPI_VERSION_REG_30 = '^3\\.0\\.\\d(-.+)?$';
export const OPENAPI_VERSION_REG_20 = '^2\\.0\\.\\d+(-.+)?$';
